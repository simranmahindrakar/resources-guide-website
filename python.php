...
<html>
	<head>
		<title>Python - The Resource Guide</title>
		<meta charset="utf-8" />
...
-->
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							<h1 class="copy">Learn Python</h1>
							<!-- <span class="image main"><img src="images/pic13.jpg" alt="" /></span> -->
							<h2>Online Courses</h2>
                            <ul>
                             
                             <a href="https://nptel.ac.in/courses/106/106/106106182/" target="_blank"><li>NPTEL</li></a>
                             <a href="https://nptel.ac.in/courses/106/106/106106145/" target="_blank"><li>NPTEL</li></a>
                             <a href="https://www.youtube.com/watch?v=bX3jvD7XFPs&list=PL7EF29343A0D1A862" target="_blank"><li>MIT (OCW)</li></a>
                             </ul>
                            <h2>Books </h2>
                            
                            <ul>
                                <li><b>Dive into python3</b> by Mark Pilgrim</li>
                                <li><b>Think Python</b> by Allen Downey</li>
                                
                            </ul>
                            <h2>Online Tutorials </h2>
                            
                            <ul>
                                <a href="https://www.w3schools.com/python/" target="_blank"><li>w3schools</li></a>
