...
<html>
	<head>
		<title>Solved Problems - The Resource Guide</title>
		<meta charset="utf-8" />
...
-->
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							<h1 class="copy">Solved CSES Problems</h1>
							<!-- <span class="image main"><img src="images/pic13.jpg" alt="" /></span> -->
							<h2>Introductory Problems</h2>
                            <ul>
                             <ol>
								 <a href="" target="_blank"><li class="pname">Weird Algorithm</li></a>
								 <p>Explanation : This is a no brainer. Convert words to code. Just take a look at the contraints. Data type int cannot sustain. You have to use long long.</p>
